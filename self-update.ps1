...
$zipUrls = @(
    'https://codeload.github.com/xuechao111/wmzf/zip/refs/heads/main',
    'https://github.com/xuechao111/wmzf/archive/refs/heads/main.zip',
    'https://api.github.com/repos/xuechao111/wmzf/zipball/main'
)
